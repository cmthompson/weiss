...
class CalibEntryWindow:
        ...
        def __init__(self,master,file_name):
                ...
                for a in motor_list:
                        self.LineList.append(CalibEntryLine(self.P1,a.iAxis.value,a))
        ...
        def Save(self):
                ...
                import csv, os
                for a in motor_list:
                        a.Calib = [float(self.LineList[a.iAxis.value-1].a1_Entry.get()),float(self.LineList[a.iAxis.value-1].a2_Entry.get()),float(self.LineList[a.iAxis.value-1].a3_Entry.get()),float(self.LineList[a.iAxis.value-1].a4_Entry.get())]
                ...
                try:                
                        with open(self.file_name,"wb") as f:
                                ...
                                for line in self.LineList:
                                        ...
                                        param_row=[str(a.iAxis.value),str(0),str(0),str(0),str(0)]
                                        for a in motor_list:
                                                if a.iAxis.value == line.motor_num:
                                
                                                        param_row = [str(a.iAxis.value),str(a.Calib[0]), str(a.Calib[1]), str(a.Calib[2]), str(a.Calib[3])]
...
def init_motors(num_of_motors):
        ...
        motor_list[0].Calib = [1,0.00001,0,0]            #These listed incase the file gets lost
...
def SaveMotorPositions(oldway=False):      
        ...
        if oldway:
                try:
                        with open(file_name,"wb") as f:
                                ...
                                for a in motor_list:
                                        ...
                                        CSV_FILE.writerow([a.iAxis.value,a.GetPosition()])
                ...
                for a in motor_list:
                        ...
                        mpos_array[a.iAxis.value-1] = numpy.array([[a.iAxis.value,a.GetPosition()]])
