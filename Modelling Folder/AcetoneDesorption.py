...
def dX_dt(X,time_in,model,minstep = 1E-3, parameters = None):
    ...
    if parameters == None:
        k1 =0# 0.1#20 #ethanol adsorption
        _k1 =0# Ethanol desorption
        k2 = 0.01#10# 5 ### Jelemensky = 10 # second dehydrogenation onto Pt (assume similar as with OH)
        k3 = 0#5#11.25 # Reaction of adosorbed ehtanol with PtOH
        k4 = 1# 2.025  # Reaction of of Ethanol with PtO

        k5 =1E-3#100#100#1 4# 50#4.5 # desoprtio of aldehyden
        k6 =1E7 #1 1E5#6.246E6 #O2 adsorption
        _k6 =1E4#k6*16#11.6E5# 1E4 O2 des
        k7 =1000#  100 # O <-> OH speed factor
...
def go():
    ...
    x.RunOut('L-H with ethoxy switch',time_limit = 4000,_plot = True)
